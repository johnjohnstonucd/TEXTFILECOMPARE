...
/*
 * TextCompareMain.java requires:
 *   TextView.java
 */
public class TextCompareMain extends JFrame implements ActionListener {
    ...
    private static void createAndShowApplication() {
        ...
        TextCompareMain frame = new TextCompareMain();
